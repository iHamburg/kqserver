...
<!--</div>-->
<!--<div class='form-group'>-->
<!--<label class="control-label">活动地点名称</label>-->
<!--	<input type="text" name="location" value="" class="form-control"  />-->
<!--	<label class="control-label">活动地点地址</label>-->
<!--	<input type="text" name="location_address" value="" class="form-control"  />-->
<!--	<span class="label "><a href="http://open.map.qq.com/doc_v2/tooles/picker.html" target='_blank'>说明：点击此处可获得活动地点的坐标</a></span>-->
<!--	<label class="control-label">活动地点坐标 X</label>-->
<!--	<input type="text" name="location_x" value="" class="form-control" placeholder="121.505796" />-->
<!--	<label class="control-label">活动地点坐标 Y</label>-->
<!--	<input type="text" name="location_y" value="" class="form-control" placeholder="31.235242" />-->
<!--</div>-->
<!--<div class='form-group'>-->
