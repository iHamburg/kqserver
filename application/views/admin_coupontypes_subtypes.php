...
<div class="row">
	 ...
	 <a href="<?php echo site_url("admin/coupontypes/create/$parentId");?>" class="btn btn-primary">新建类型</a>
...
//				echo "<td>".$list['realname']."</td>";
				...
				echo "<td align='center'>".anchor('admin/coupontypes/edit/'.$list['objectId'],'编辑')." | ".anchor("admin/coupontypes/delete/$id/$parentId",'删除')."</td>";
				echo "</tr>";
